...
const App = () => {
  ...
  const removeFromCart = (item) => {
    setCart((currentCart) => {
      ...
      return [...currentCart.slice(0, indexOfItemToRemove), ...currentCart.slice(indexOfItemToRemove + 1)];
    });
  };
    ...
    <main className='wrapper'>
      ...
      <section className='checkout'>
        ...
        <section className='checkout__cart'>
          ...
          <button className='checkout__proceed checkout__proceed--total'>Proceed to checkout</button>
        </section>
      </section>
    </main>
  );
